...
import { GeneralSubmitButton } from "./SubmitButtons";
      ...
      <div className="flex flex-col gap-6 bg-[#1B1918] rounded-2xl p-8 border-[#333333] border">
        ...
        <div className="content">
          <div className="flex flex-col gap-4">
            ...
            >
              <GeneralSubmitButton text="Login with GitHub" icon={<Github />} />
            </form>
            <form
              action={async () => {
                "use server";
            ...
            >
              <GeneralSubmitButton text="Login with Google" icon={<Google />} />
            </form>
          </div>
        </div>
      </div>
